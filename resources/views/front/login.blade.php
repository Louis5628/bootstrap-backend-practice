...
<head>
    ...
    <title>@section('title', '登入')</title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.2.1/css/bootstrap.min.css"
        integrity="sha384-GJzZqFGwb1QTTN6wy59ffF1BuGJpLSa9DkKMp0DgiMDm4iYMj70gZWKYbI706tWS" crossorigin="anonymous">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css">

    <link rel="stylesheet" href="{{ asset('css/digipack-login.css') }}">
</head>
...
<body>
    ...
    <main>
        <div class="row no-gutters">
            <div class="col">
                <div class="back-image position-absolute"></div>
                    ...
                    <div class="row no-gutters">
                        <div class="col-0 col-lg-6
                            ...
                            <div class="word">
                                ...
                                <p class="my-3">Capture your personal memory in unique way, anywhere.</p>
                            </div>
                        </div>
                        <div class="links position-absolute d-flex justify-content-center p-lg-3">
                            <a href=""><svg fill="#fff" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24">
                                    <path
                                        d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z">
                                    </path>
                                </svg></a>
                            <a class="mx-3" href=""><svg fill="#fff" xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="row d-flex align-content-lg-center align-content-center no-gutters position-relative right"
                                style="height: 100vh;">
                                <div class="col-12 d-flex justify-content-center">
                                    <h2 class="my-2"><svg class="logo w-auto inline-flex"
                                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 115.8 31.77">
                                            <defs>
                                                <style>
                                                    .cls-1 {
                                                        fill: #fff;
                                ...
                                <div class="col-12 d-flex flex-row py-4 justify-content-center">
                                    <div class="link rounded-circle d-flex justify-content-center align-items-center">f
                                    </div>
                                    <div
                                        class="link rounded-circle d-flex justify-content-center align-items-center mx-3">
                                        G+
                                    </div>
                                    <div class="link rounded-circle d-flex justify-content-center align-items-center">in
                                    </div>
                                </div>
                                <div class="col-12 d-flex justify-content-center">
